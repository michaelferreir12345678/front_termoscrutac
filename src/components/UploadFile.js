...
function UploadPage() {
    ...
    const [startDateEstagio, setStartDateEstagio] = useState("");
    const [endDateEstagio, setEndDateEstagio] = useState("");
    ...
    return (
      <div className="container mt-5">
          ...
          <p className="text-muted">A planilha deve conter as colunas: Nome; CPF; Matrícula; Endereço; Cidade/UF; Telefone.</p>
  
          {backendError && <div className="alert alert-danger">{backendError}</div>}
  
          <div className="row mb-2">
              <p className="text-muted text-start">Estágio: </p>
              <div className="col-md-4">
                  <Calendar
                      value={startDateEstagio}
                      onChange={(e) => setStartDateEstagio(e.value)}
                      showIcon
                      placeholder="Data Início do Estágio"
                      dateFormat="dd/mm/yy"
              ...
              <div className="col-md-4">
                  <Calendar
                      value={endDateEstagio}
                      onChange={(e) => setEndDateEstagio(e.value)}
                      showIcon
                      placeholder="Data Final do Estágio"
                      dateFormat="dd/mm/yy"
                      className="w-100 input-height"
                  />
              </div>
          </div>
          <p className="text-muted text-start mt-4">Seguro: </p>
          ...
          <button
              className="btn btn-primary mt-3 input-height"
          ...
          {studentsData.length > 0 && (
              <div className="mt-5">
                  ...
                  <DataTable value={studentsData} responsiveLayout="scroll" stripedRows>
                      ...
                      <Column
                          ...
                          body={(rowData) => (
                              <div>
                                  <select
                                      className={`form-select input-height ${errors[rowData.name] ? "is-invalid" : ""}`}
                  ...
                  <button
                      className="btn btn-success mt-4 input-height mb-5"
